...
function seed(): void {
  ...
  const paintings: Painting[] = [
    ...
    // Miscellaneous — provided art assets awaiting real titles/details.
    // Placeholder copy; Kelly renames and describes these in Sanity Studio.
    {
      _id: "painting.untitled-study-1",
      _rev: rev(),
      title: "Untitled study, no. 1",
      slug: { current: "untitled-study-1" },
      category: "miscellaneous",
      year: 2025,
      medium: "Mixed media",
      ...
      price: 1200,
      status: "available",
      primaryImage: localImage("img_0009.jpg", "Untitled study, no. 1."),
      createdAt: nowIso(),
    },
    {
      _id: "painting.untitled-study-2",
      _rev: rev(),
      title: "Untitled study, no. 2",
      slug: { current: "untitled-study-2" },
      category: "miscellaneous",
      year: 2025,
      medium: "Mixed media",
      ...
      price: 1200,
      status: "available",
      primaryImage: localImage("img_5870.jpg", "Untitled study, no. 2."),
      createdAt: nowIso(),
    },
    {
      _id: "painting.untitled-study-3",
      _rev: rev(),
      title: "Untitled study, no. 3",
      slug: { current: "untitled-study-3" },
      category: "miscellaneous",
      year: 2025,
      medium: "Mixed media",
      ...
      price: 1200,
      status: "available",
      primaryImage: localImage("img_6355.jpg", "Untitled study, no. 3."),
      createdAt: nowIso(),
    },
    {
      _id: "painting.untitled-study-4",
      _rev: rev(),
      title: "Untitled study, no. 4",
      slug: { current: "untitled-study-4" },
      category: "miscellaneous",
      year: 2025,
      medium: "Mixed media",
      ...
      price: 1200,
      status: "available",
      primaryImage: localImage("img_7554.jpg", "Untitled study, no. 4."),
      createdAt: nowIso(),
    },
